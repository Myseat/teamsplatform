...
- [Microsoft Teams 平台概述](teamsplatform-overview/preface.md)
- [Microsoft Teams 及其发展过程](teamsplatform-overview/teams-roadmap.md)
- [平台定位和架构](teamsplatform-overview/teamsplatform-architecture.md)
- [平台能力一览](teamsplatform-overview/teamsplatform-capabilities/README.md)
  ...
  - [Power Platform 整合](teamsplatform-overview/teamsplatform-capabilities/power-platform-integration.md)

## 从最终用户角度看平台

- [从最终用户角度看平台](user-perspective-of-the-platform/preface.md)
- [安装和配置 Teams](user-perspective-of-the-platform/install-configure-teams.md)
...
- [从 IT 管理运营角度看平台](it-perspective-of-the-platform/preface.md)
- [规划 Teams 和推广路径](it-perspective-of-the-platform/plan-and-adoption.md)
...
- [结合 Power Platform 释放更大潜能](power-platform-integration/preface.md)
- [Power Platform 架构和设计理念](power-platform-integration/powerplatform-overview.md)
- [使用 PowerApps 创建和分发应用](power-platform-integration/use-powerapps-with-teams.md)
- [基于 Power Automate 的自动化](power-platform-integration/power-automate-with-teams.md)
- [Power Virtual Agent 机器人应用](power-platform-integration/power-virtual-agents-bot-with-teams.md)
- [在 Teams 中使用 Power BI](power-platform-integration/power-bi-with-teams.md)
